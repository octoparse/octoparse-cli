          ...
          preferredWorkflow: [
            {
              ...
              output: 'agent context JSON containing decisionSummary, visualArtifacts, recommendedCandidateId, decisionPolicy, resultValidationPolicy, candidates, fields, visualElements, sampleRows, XPath, diagnostics, pagination, goal, and screenshot metadata. Full-page and annotated screenshots plus top candidate crops are generated by default for agent workflows when diagnostics provide boxes; screenshots may include V* labels for source=visible_dom visualElements.'
            },
            {
              step: 'writePlan',
